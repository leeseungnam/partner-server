                ...
                .andDo(
                        document("delivery-find",
                                ...
                                responseFields(
                                        ...
                                        fieldWithPath("data.deliveryCompleteList[]").type(JsonFieldType.ARRAY).optional().description("배송완료 상품 목록"),
                                        fieldWithPath("data.deliveryCompleteList[].orderProductSeq").type(JsonFieldType.NUMBER).description("주문 상품 SEQ"),
                                        fieldWithPath("data.deliveryCompleteList[].productCode").type(JsonFieldType.STRING).description("상품 코드"),
                                        fieldWithPath("data.deliveryCompleteList[].productName").type(JsonFieldType.STRING).description("상품 이름"),
                                        fieldWithPath("data.deliveryCompleteList[].optionName").type(JsonFieldType.STRING).description("옵션 이름"),
