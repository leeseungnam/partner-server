package kr.wrightbrothers.framework.util.excel.option;
...
/**
 * Excel(xls, xlsx) 파일을 읽을 때, 필요한 옵션을 정의한다. 여기에 정의된 옵션들을 사용해서 실제 파일을 읽어 온다.
 */
public class ReadOption {
	...
	public ReadOption(String filePath) {
		this.filePath = filePath;
	}

	public ReadOption(File file) {
		this.filePath = file.getPath();
	}

	public ReadOption(InputStream inputStream, String name) {
	...
	/**
	 * Excel에서 추출을 시작하고 싶은 Row를 지정한다. Excel문서와 동일하게 1부터 시작한다.
	 * 
	 * @param int 추출 시작 번호
	 */
