...
public class AdminDataBase {
	...
	@Value("${spring.datasource-admin.maximumPoolSize}")
	private int maximumPoolSize;
	
	@Bean(name = WBConfig.Mybatis.AdminDataSource)
	@Primary
	...
	@Bean(name = WBConfig.Mybatis.AdminLog4jdbcProxySource)
	@Primary
	...
	@Bean(name = WBConfig.Mybatis.AdminSqlSessionFactory)
	@Primary
	...
	@Bean(name = WBConfig.Mybatis.AdminSqlSessionTemplate)
	@Primary
	public SqlSessionTemplate SqlSessionTemplate() throws Exception {
		return new SqlSessionTemplate(SqlSessionFactory());
	}

	@Bean(name = WBConfig.Mybatis.AdminTransactionManager)
	@Primary
