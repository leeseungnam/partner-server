        ...
        http
            ...
            .and()
                ...
                .antMatchers("/v1/sign/login","/v1/sign/logout/response"
                        , "/v1/email/single", "/v1/user", "/v1/user/auth/email", "/v1/noti/**"
...
//                .logoutUrl("/v1/sign/logout")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:3300", "http://3.36.25.109:3300", "http://13.209.45.4:3300"));
